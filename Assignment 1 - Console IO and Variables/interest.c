...
int main(){
	...
	//	   of double.
	printf("Enter the principle amount of loan: ");
	...
	printf("Your total payable interest is %lf when the principal_amount given as %lf , duration is %d", total_interest,principal_amount,duration);
	//
